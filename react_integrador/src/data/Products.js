export const products = [
  {
    id: 1,
    title: "Café Blend De La Casa",
    img: "/images/producto_9.png",
    description:
      "Intensidad: Suave. Notas: Cereza, frutos rojos, avellanas tostadas y miel.",
    price: 2300,
  ...
  },
  {
    ...
    description:
      "Intensidad: Media. Notas: Azúcar mascabo, almendras tostadas y madera.",
    price: 2300,
  ...
  {
    id: 4,
    title: "Café Molido Perú Intenso",
  ...
  },
  {
    ...
    description:
      "Intensidad: Suave. Café tostado natural en grano de especialidad.",
    price: 2800,
    category: "PrensaFrancesa",
  },
  {
    ...
    description:
      "Intensidad: Intenso. Notas: Chocolate amargo y avellana tostada.",
    price: 2200,
    category: "Chemex",
  },
  {
  ...
  },
  {
    ...
    description:
      "Intensidad: Media. Notas: Chocolate dulce, caramelo, almendra, limón.",
    price: 3000,
    category: "Chemex",
  },
  {
    id: 10,
    title: "Café Ethiopia Blend",
  ...
  {
    id: 11,
    title: "Café Molido Moka Intenso",
  ...
  {
    id: 12,
    title: "Café Vainilla Blend",
    img: "/images/producto_11.png",
    description:
      "Intensidad: Media. Notas: Chocolate dulce, caramelo, almendra, limón.",
    price: 3000,
    category: "PrensaFrancesa",
